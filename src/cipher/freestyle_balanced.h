#ifndef BLFS_CIPHER_FREESTYLE_BALANCED_H_
#define BLFS_CIPHER_FREESTYLE_BALANCED_H_
 ...
 */
void sc_impl_freestyle_balanced(blfs_swappable_cipher_t * sc);

#endif /* BLFS_CIPHER_FREESTYLE_BALANCED_H_ */
