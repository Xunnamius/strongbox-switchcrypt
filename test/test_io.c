...
void test_blfs_backstore_create_work_as_expected(void)
{
    ...
    TEST_(0, backstore->kcs_real_offset);
    TEST_(0, backstore->tj_real_offset);
    TEST_(0, backstore->kcs_journaled_offset);
    TEST_(0, backstore->tj_journaled_offset);
    TEST_(0, backstore->nugget_journaled_offset);
    TEST_(0, backstore->body_real_offset);
    TEST_(0, backstore->writeable_size_actual);
    TEST_(0, backstore->nugget_size_bytes);
    TEST_(0, backstore->flake_size_bytes);
    TEST_(0, backstore->num_nuggets);
    TEST_(0, backstore->flakes_per_nugget);
    TEST_(4096, backstore->file_size_actual);
}
...
void test_blfs_backstore_open_work_as_expected(void)
{
    ...
    TEST_(133, backstore->tj_real_offset);
    TEST_(136, backstore->kcs_journaled_offset);
    TEST_(144, backstore->tj_journaled_offset);
    TEST_(145, backstore->nugget_journaled_offset);
    TEST_(161, backstore->body_real_offset);
    TEST_(48, backstore->writeable_size_actual);
    TEST_(16, backstore->nugget_size_bytes);
    TEST_(8, backstore->flake_size_bytes);
    TEST_(3, backstore->num_nuggets);
    TEST_(2, backstore->flakes_per_nugget);
    TEST_(209, backstore->file_size_actual);
}
