...
void test_blfs_chacha20_struct_hash_returns_expected_data(void)
{
    uint8_t actual_hash[BLFS_CRYPTO_BYTES_STRUCT_HASH_OUT] = { 0x00 };
    ...
    uint8_t expected_hash[BLFS_CRYPTO_BYTES_STRUCT_HASH_OUT] = {
        0x0f, 0x58, 0x41, 0xe2, 0xae, 0xfc, 0xc6, 0xf4, 0x99, 0xc9, 0x9e, 0xae,
        0x67, 0x94, 0xeb, 0x04
    };

    blfs_chacha20_struct_hash(actual_hash, input_vector, sizeof input_vector, secret);
...
void test_blfs_poly1305_key_from_data_fails_bad_endianness(void)
{
    ...
    uint8_t nugget_key[BLFS_CRYPTO_BYTES_KDF_OUT] = {
        0xd9, 0x2e, 0x63, 0x4c, 0xd9, 0xaa, 0x01, 0xea,
        0xa5, 0xad, 0xdc, 0x68, 0xcf, 0xe1, 0x8f, 0xc1,
        0xa7, 0xa5, 0x10, 0x4b, 0x63, 0x1b, 0x46, 0x2d,
        0x78, 0xda, 0xb6, 0x18, 0x18, 0x06, 0x19, 0xab
    };
    ...
    uint8_t expected_key[BLFS_CRYPTO_BYTES_FLAKE_TAG_KEY] = {
        0xd9, 0x2e, 0x63, 0x4c, 0xd9, 0xaa, 0x01, 0xea,
        0xa6, 0xad, 0xdc, 0x68, 0xcf, 0xe1, 0x8f, 0xc1,
        0xa9, 0xa5, 0x10, 0x4b, 0x63, 0x1b, 0x46, 0x2d,
        0x78, 0xda, 0xb6, 0x18, 0x18, 0x06, 0x19, 0xab
    };
